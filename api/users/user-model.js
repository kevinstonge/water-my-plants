...
const updatePhone = async (userObject) => {
  try {
    return await db('users').where({username: userObject.username}).update({phone: userObject.phone});
  }
  catch (error) {
    throw error;
  }
...
module.exports = { createUser, getUserByUsername, updatePassword, updatePhone };
